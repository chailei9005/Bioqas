    ...
    kafkaStream.foreachRDD(rdd => {
      ...
      if (rdd != null) {
        ...
        val ss = SparkSession.builder().config(conf).getOrCreate()
          ...
          resultDF.repartition(4).foreachPartition(rows => {
...
//          ss.sql("uncache table result_cache")
          ...
          p3sdDF.repartition(4).foreachPartition(rows => {
          ...
          p2sdDF.repartition(4).foreachPartition(rows => {
          ...
          resultCALDF.repartition(4).foreachPartition(rows => {
...
//          ss.sql("uncache table resultCAL_cache")
          ...
          p3sdCALDF.repartition(4).foreachPartition(rows => {
          ...
          p2sdCALDF.repartition(4).foreachPartition(rows => {
          ...
          resultLabDF.repartition(4).foreachPartition(rows => {
...
//          ss.sql("cache table resultLab_cache as select * from resultLab")
          ...
          p3sdLabDF.repartition(4).foreachPartition(rows => {
          ...
          p2sdLabDF.repartition(4).foreachPartition(rows => {
          ...
          resultMethodDF.repartition(4).foreachPartition(rows => {
...
//          ss.sql("uncache table resultMethod_cache")
          ...
          p3sdMethodDF.repartition(4).foreachPartition(rows => {
          ...
          p2sdMethodDF.repartition(4).foreachPartition(rows => {
          ...
          resultReagentDF.repartition(4).foreachPartition(rows => {
...
//          ss.sql("uncache table resultReagent_cache")
          ...
          p3sdReagentDF.repartition(4).foreachPartition(rows => {
          ...
          p2sdReagentDF.repartition(4).foreachPartition(rows => {
