...
object OracleUtils {
  ...
  val insertSql = "insert into TEST.TP_E_BD_STATISTICS_RESULT(" +
    "ID,CENTER_ID,PLAN_ID,SPEC_ID,TIMES_NAME," +
  ...
  def insertBatch(pstmt: PreparedStatement,value:Row,pk_id: String,group_type: Int): Unit ={
    ...
    pstmt.setString(5,value.getAs[String](4))
    ...
    pstmt.setInt(15,group_type)

    if(group_type != 0){
//      println(value.getAs[Integer](13))
      if("".equals(value.getAs[Integer](13)) || value.getAs[Integer](13) != null){
        pstmt.setInt(16,value.getAs[Integer](13))
      }else{
        pstmt.setInt(16,-1)
      }
//      pstmt.setInt(16,999)
