...
/**
  ...
  */
class AlgorithmAMeanValueUDAF extends UserDefinedAggregateFunction{
...
//    println("////////////// " + intArray)
    ...
    val len = list.size
    val statisticsA: RetRobustObj = AlgorithmA.RobustStatisticsA(list)

    statisticsA.getRobustMean
  }
